			...
			<div className="flex flex-wrap gap-10 items-center justify-center py-[50px]">
				{offersData &&
					offersData.map((item, idx) => {
						return (
							<div key={idx} className="w-[300px] lg:w-[500px] py-10 flex flex-col items-center justify-center bg-blue5 rounded-xl  dark:bg-dark4 ease-in-out duration-200 cursor-pointer">
								...
								<div className="flex flex-col items-center justify-center">
									...
									{item.sellAmount}{item.sellCurrency} &nbsp;
										<i className="fa-solid text-sm fa-arrow-right-arrow-left"></i>
										&nbsp; {(item.sellAmount)*(item.sellRate)}{item.buyCurrency}
									</p>
									<NavLink
										// onClick={openNav}
